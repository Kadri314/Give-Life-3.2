try { window.scriptsLoaded = window.scriptsLoaded || {}; window.scriptProcessStart = window.scriptProcessStart || {}; window.scriptProcessStart['markdown-it.min.js'] = (new Date()).getTime();
...
window.scriptsLoaded['markdown-it.min.js'] = 1; window.scriptProcessEnd = window.scriptProcessEnd || {}; window.scriptProcessEnd['markdown-it.min.js'] = (new Date()).getTime(); } catch(e) { window.owaLastErrorReported = e; throw e; }
