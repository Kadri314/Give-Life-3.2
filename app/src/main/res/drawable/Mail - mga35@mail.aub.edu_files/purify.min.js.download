try { window.scriptsLoaded = window.scriptsLoaded || {}; window.scriptProcessStart = window.scriptProcessStart || {}; window.scriptProcessStart['purify.min.js'] = (new Date()).getTime();
...
window.scriptsLoaded['purify.min.js'] = 1; window.scriptProcessEnd = window.scriptProcessEnd || {}; window.scriptProcessEnd['purify.min.js'] = (new Date()).getTime(); } catch(e) { window.owaLastErrorReported = e; throw e; }
